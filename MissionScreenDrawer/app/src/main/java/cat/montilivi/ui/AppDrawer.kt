...
import cat.montilivi.ui.navigation.NavigationGraphDrawer
...
@Composable
fun MyScaffold(navigationController: NavHostController, currentDestination: NavDestination?, drawerState: DrawerState, coroutineScope: CoroutineScope) {
    val navigationState = navigationController.currentBackStackEntryAsState();
    val currentDestination = navigationState.value?.destination;
