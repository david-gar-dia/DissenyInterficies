...
import cat.montilivi.ui.navigation.NavigateEntityListScreen
import cat.montilivi.ui.navigation.NavigateMissionListScreen
...
@Composable
fun AppNavigationRail(navigationController: NavHostController) {
