...
data class NavigationTabsInfo<T: Any> (
    val route: T,
    val title: String,
    val selectedIcon: ImageVector,
    val unselectedIcon: ImageVector
...
val tabTags = listOf(
    NavigationTabsInfo(CoverScreenDestination,"Cover",Icons.Filled.Home,Icons.Outlined.Home),
    NavigationTabsInfo(SubGraphZoneList,"Zones",Icons.Filled.Terrain,Icons.Outlined.Terrain),
    NavigationTabsInfo(SubGraphEntityList,"Entities",Icons.Filled.Person,Icons.Outlined.Person),
    NavigationTabsInfo(SubGraphMissionList,"Missions",Icons.Filled.CheckCircle,Icons.Outlined.Check),
    NavigationTabsInfo(InstructionsScreenDestination,"Instructions",Icons.Filled.Info,Icons.Outlined.Info),
    NavigationTabsInfo(WhenAtScreenDestination,"When at...",Icons.Filled.Adb,Icons.Outlined.Adb),
    NavigationTabsInfo(PreferencesScreenDestination,"Preferences",Icons.Filled.Build,Icons.Outlined.Build)
)
